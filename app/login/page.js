...
const Login = () => {
  ...
  // Don't render login content if authenticated
  if (status === "authenticated") {
    return null;
  }
  return (
    <>
      <div className="flex flex-col items-center justify-center min-h-[75.3vh] md:min-h-[80.3vh] p-6">
        <h2 className="text-3xl font-semibold text-white mb-8 text-center">
          Sign in with
        </h2>
        <div className="flex flex-col gap-4 w-full max-w-xs">
          <button className="flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 w-full">
            <svg
          ...
          <button className="flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 w-full">
            ...
            <span className="ml-1">Continue with Twitter</span>
          </button>
          <button className="flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 w-full">
            <svg
              className="h-6 w-6 mr-2 flex-shrink-0"
          ...
          <button
            ...
            className="flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 w-full"
          >
            <svg
              className="h-6 w-6 mr-2 flex-shrink-0"
              xmlns="http://www.w3.org/2000/svg"
